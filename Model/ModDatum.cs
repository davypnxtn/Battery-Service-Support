...
namespace Model
{
    public class ModDatum
    {
        ...
        public DateTime LeveradresModDatum { get; set; }
        public DateTime KlantModDatum { get; set; }
        public DateTime GemeenteModDatum { get; set; }
        public DateTime LandModDatum { get; set; }
        public DateTime ArtikelModDatum { get; set; }
    }
}
